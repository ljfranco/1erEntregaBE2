...
DELETE FROM producto_lista_ventas WHERE lista_productos_id IS NOT NULL;
DELETE FROM venta WHERE id_venta IS NOT NULL;
DELETE FROM producto WHERE id IS NOT NULL;

-- Reiniciar las secuencias (si se están utilizando secuencias en tu base de datos, de lo contrario, omite estas líneas)
UPDATE producto_seq
SET next_val = 1;
